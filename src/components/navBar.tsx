...
export default function NavBar() {
    ...
    return (
        <nav className="fixed top-4 md:top-6 left-0 w-full flex justify-center h-12 md:h-14 z-50 pointer-events-none px-4">
            <div className="bg-[#1d2d44]/90 backdrop-blur-md border border-[#3e5c76]/50 shadow-[0_0_15px_rgba(62,92,118,0.3)] rounded-full h-full w-full max-w-[360px] md:max-w-[500px] p-1 relative isolate pointer-events-auto">
